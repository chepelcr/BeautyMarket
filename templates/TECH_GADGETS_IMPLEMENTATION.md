...
### Deployment URL
**Live:** https://tech-gadgets-example.jmarkets.jcampos.dev

### S3 Bucket
- Bucket name: `tech-gadgets-example.jmarkets.jcampos.dev`
- Region: us-east-1
- CloudFront distribution required for SSL

### DNS Configuration
- CNAME: tech-gadgets-example.jmarkets.jcampos.dev
- Points to CloudFront distribution
- Uses wildcard SSL cert: `*.jmarkets.jcampos.dev`
