...
export function CreateConfirmationDialog({ open, onOpenChange, organizationId }: CreateConfirmationDialogProps) {
  ...
  const createMutation = useCreateConfirmation(organizationId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: t('confirmations.create.success') });
      ...
      toast({
        title: t('confirmations.create.error'),
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t('confirmations.create.title')}</DialogTitle>
          <DialogDescription>{t('confirmations.create.description')}</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="confirmationNumber">{t('confirmations.create.numberLabel')}</Label>
              <Input
