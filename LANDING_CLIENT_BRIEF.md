...
2. **Custom Subdomains** - Professional branded URLs (yourstore.jmarkets.jcampos.dev)
...
- Admin dashboard (admin.jmarkets.jcampos.dev)
- Customer stores (*.jmarkets.jcampos.dev)
